...
A Cisco IOS lab exploring Area 0 OSPF, VLAN segmentation, 802.1Q trunks, inter-VLAN routing, NAT, and extended ACLs.

[Explore the network lab](gns3-network.md){ .md-button }
